    ...
    <div className="admin-panel">
      <div className="admin-panel-header">
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
          <Link className="btn btn-outline btn-sm" to="/admin/payments" title="Suivi des encaissements">Paiements</Link>
          <Link className="btn btn-ghost btn-sm" to="/admin/accounting/treasury" title="Trésorerie et comptes bancaires">Trésorerie</Link>
