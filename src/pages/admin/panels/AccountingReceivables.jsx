    ...
    <div className="admin-panel">
      <div className="admin-panel-header">
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
          <Link className="btn btn-outline btn-sm" to="/admin/invoices" title="Toutes les factures (relances, encaissement, PDF)">Factures</Link>
          <Link className="btn btn-ghost btn-sm" to="/admin/tiers" title="Liste des tiers (clients)">Clients</Link>
