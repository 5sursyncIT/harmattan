...
const ACTION_OPTIONS = [
  ...
  { value: 'validate', label: 'Validation facture' },
  { value: 'renegotiate', label: 'Renégociation' },
  { value: 'renegotiate_failed', label: 'Renégociation interrompue' },
